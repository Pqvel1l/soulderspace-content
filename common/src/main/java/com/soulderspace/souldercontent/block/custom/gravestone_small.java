...
public class gravestone_small extends Block {
    private static final VoxelShape TWO_BLOCKED_HORIZONTAL = VoxelShapes.cuboid(0.0625f, 0.0f, 0.0625f, 1f, 0.3f, 0.8f);

    public gravestone_small() {
