...
public class gravestone_vertical extends Block {
    private static final VoxelShape TWO_BLOCKED_HORIZONTAL = VoxelShapes.cuboid(0.0625f, 0.0f, 0.0625f, 1f, 0.865f, 1f);

    public gravestone_vertical() {
