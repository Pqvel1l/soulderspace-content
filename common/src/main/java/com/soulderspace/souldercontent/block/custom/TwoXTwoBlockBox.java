...
public class TwoXTwoBlockBox extends Block {
    private static final VoxelShape CasinoTableShape =VoxelShapes.cuboid(0.0f, 0.0f, 0.0f, 2.0f, 2f, 1.0f);

    public TwoXTwoBlockBox() {
